...
function configureExpoAndLanding(app: express.Application) {
  ...
  const deployFileMap: Record<string, string> = {
  ...
  app.get("/deploy-file/:name", (req: Request, res: Response) => {
  ...
  if (fs.existsSync(presPath)) {
    app.get("/presentation", (_req: Request, res: Response) => {
  ...
  if (fs.existsSync(deployGuidePath)) {
    app.get("/deploy-guide", (_req: Request, res: Response) => {
  ...
  if (fs.existsSync(deployArchivePath)) {
    app.get("/download-deploy", (_req: Request, res: Response) => {
